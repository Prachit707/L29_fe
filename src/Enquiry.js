...
export default function Enquiry()
{
	...
	const validate = (values)=>{
		...
		if (! values.name.match('[A-Za-z ]+'))
			errors.name="name should contain alphabhets only";
	...
	const onSubmit = (values,{resetForm})=>{
		...
		let urladd = "https://l29-ivvx8q574-prachit707.vercel.app/save";
	...
	<br/><br/>
	<textarea name="query" placeholder="Enter your Query" rows={5} cols={30} onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.query}/>
